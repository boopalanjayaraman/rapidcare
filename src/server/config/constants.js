module.exports = {
    ...
    productType_health : "health",
    productType_term : "term",
    ...
    claimRelationship_self : 'self',
    claimRelationship_nominee : 'nominee',
    claimRelationship_partnerdoctor : 'partnerdoctor',
    claimType_medical : 'medical',
    claimType_life : 'life',
    rapydConstants : {
        http_get_method : 'get',
